                ...
                if(nowx>=365&&nowx<=455){
                    if(fow==0){
                        ...
                        move_ = 0;
                         ...
                         ui->watergirl->setPixmap(QPixmap(":/image/ghost.png").scaled(20,20)); // 设置蓝色角色的鬼图
                ...
                if(nowx>=530&&nowx<=620){
                    if(nowy==537&&fow==0){
                        move_ = 0;
                          ...
                          ui->fireman->setPixmap(QPixmap(":/image/ghost.png").scaled(20,20)); // 设置红色角色的鬼图
...
void game::reset()
{
    ui->fireman->setPixmap(QPixmap(":/image/fireman.png")); // 设置红色角色的鬼图
     ui->watergirl->setPixmap(QPixmap(":/image/watergirl.png")); // 设置红色角色的鬼图
    x[0]=55,y[0]=537,x[1]=55,y[1]=445;
    ay[0]=0,ay[1]=0,vy[0]=0,vy[1]=0,vx[0]=0,vx[1]=0;
    minx[0]=35,miny[0]=510,maxy[0]=537,maxx[0]=765;
    minx[1]=35,miny[1]=430,maxy[1]=452,maxx[1]=765;
